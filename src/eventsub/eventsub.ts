...
export class EventsubClient {
    ...
    revocation<K extends keyof EventsubRevocationEventMap>(
        ...
        return new SubscriptionEventEmitter<EventsubRevocationEventMap, K>(type, this.revocationEmitter)
    }
    notification<K extends keyof EventsubNotificationEventMap>(
        type: K,
    ) {
        return new SubscriptionEventEmitter<EventsubNotificationEventMap, K>(type, this.notificationEmitter)
    }
